...
<html lang="en">
  <head>
    ...
    <link href="{{url('frontend/dist/css/validetta.css')}}" rel="stylesheet"/>
      ...
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="{{url('frontend/static/logo.svg')}}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <a class="dropdown-item" href="{{url('/blank')}}">
                          Blank page
                        </a>
                        ...
                        <a class="dropdown-item" href="{{url('/getCustomer')}}">
                          Data grid
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        
                        <a class="dropdown-item" href="{{url('/listUser')}}">
                          Datatables
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{url('/showUser')}}">
                          Datatables 2
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      ...
                      <div class="dropdown-menu-column">
                        ...
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{url('/signInpage')}}" class="dropdown-item">
                              Sign in
                            </a>
                            ...
                            <a href="{{url('/signUppage')}}" class="dropdown-item">
                              Sign up
                            </a>
