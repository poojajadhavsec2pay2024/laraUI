    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
      ...
      <div class="offcanvas-body">
        <div class="container">
            ...
            <form id="txncheckstatus" class="d-none" method="post" action="{{ route('fetchTransactionStatus') }}">
                @csrf
            ...
            <div id="collapse-1" class="accordion-collapse collapse mb-3" data-bs-parent="#accordion-example">
                <div class="accordion-body pt-0">
                    <form id="txndmtstatusupdate" method="post" action="">
                       @csrf
            ...
            <div id="dmt-refund" class="accordion-collapse collapse mb-3" data-bs-parent="#accordion-example">
                ...
                <div style="display:none" id="enter-refund-otp">
                    <form id="txnrefund" method="post" action="">
                        @csrf
	   ...
	   /* $('#dt_status').text(status);
        ...
        if(grpid == 'null' || grpid == ''){
            ...
            $.ajax({
                ...
                url: '', // The URL of the controller action to call
                data: {
                    _token: "{{ csrf_token() }}",
                    grpid,txnid
                },
